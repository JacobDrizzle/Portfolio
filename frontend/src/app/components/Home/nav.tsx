...
const Navbar  = () => {
  return (
    ...
    <nav className="flex justify-center">
        <ul className="flex flex-row justify-center bg-slate-900 dark:bg-black py-2 px-12 rounded-3xl border border-[rgba(255,255,255,0.2)] hover:border-emerald-400">
