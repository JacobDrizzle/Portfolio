...
const Hero = () => {
  const heroCards = [
    ...
    },
    {
      ...
      description:
        "My toolbox consist of C++, Java, with a dash of TypeScirpt and Python. If you're on the hunt for an versatile virtuoso who also knows how to handle a backend, look no further. Hit me up!",
      alt_description:
